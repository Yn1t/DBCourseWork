...
class Pub(QMainWindow):
    ...
    def initAddBar(self):
        ...
        bar_menu = QAction(QIcon('resources/bar_menu.png'), 'Барное меню', self)
    ...
    def initGetBar(self):
        ...
        get_bar_menu = QAction(QIcon('resources/bar_menu.png'), 'Барное меню', self)
    ...
    def initChangeBar(self):
        ...
        change_bar_menu = QAction(QIcon('resources/bar_menu.png'), 'Барное меню', self)
    ...
    def initSchemeBar(self):
        ...
        scheme_action = QAction(QIcon('resources/dish.png'), 'Блюдо', self)
